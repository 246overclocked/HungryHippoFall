...
public class AnalogPot implements Potentiometer, LiveWindowSendable {
	 ...
	 * 
	 * @param input
	 *            The {@link AnalogInput} this potentiometer is plugged into.
	 * @param fullRange
	 *            The scaling to multiply the voltage by to get a meaningful
	 *            unit.
	 * @param offset
	 *            The offset to add to the scaled value for controlling the zero
	 *            value
	 */
	 ...
	 * meaningful values. I.E: you have a 270 degree potentiometer and you want
	 * the output to be degrees with the halfway point as 0 degrees. The
	 * fullRange value is 270.0(degrees) and the offset is -135.0 since the
	 * halfway point after scaling is 135 degrees.
	 * 
	 * This will calculate the result from the fullRange times the fraction of
	 * the supply voltage, plus the offset.
	 *
	 * @param channel
	 *            The analog channel this potentiometer is plugged into.
	 * @param fullRange
	 *            The scaling to multiply the fraction by to get a meaningful
	 *            unit.
	 * @param offset
	 *            The offset to add to the scaled value for controlling the zero
	 *            value
	 ...
	 *            The analog channel this potentiometer is plugged into.
	 * @param onRio
	 *            Whether or not the code is running on the RoboRIO
	 */
	...
	/**
	 * Get the current potentiometer reading without any scaling or offsets
	 * 
	 * @return The current raw output of the potentiometer
	 */
