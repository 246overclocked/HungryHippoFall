...
public class VectorPIDController {
	...
	// constructors
	public VectorPIDController(double Kp, double Ki, double Kd, double Kf, VectorPIDSource source,
			VectorPIDOutput output, double period) {
	...
	public VectorPIDController(double Kp, double Ki, double Kd, VectorPIDSource source, VectorPIDOutput output, double period) {
		this(Kp, Ki, Kd, 0, source, output, period);
	}

	public VectorPIDController(double Kp, double Ki, double Kd, VectorPIDSource source, VectorPIDOutput output) {
		this(Kp, Ki, Kd, 0, source, output, 20);
	}

	public VectorPIDController(double Kp, double Ki, double Kd, double Kf, VectorPIDSource source,
			VectorPIDOutput output) {
	...
	public void setSetpoint(Vector2D setpoint) {
		...
		// We calculate the distance between the input and setpoint vectors in
		// regularSource.pidGet(),
