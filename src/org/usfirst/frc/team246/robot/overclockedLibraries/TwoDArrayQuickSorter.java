...
/**
 * The Class TwoDArrayQuickSorter.
 *
 * @author Jacob Nazarenko - Creds to Gaddis's Java Textbook for the structure
 *         of this code
 */
public class TwoDArrayQuickSorter {
	 ...
	 * the values of the array[i][0] are in ascending order: 1, 3, 5, 7. If you
	 * sorted this array by index 1, however, you would end up with
	...
	/**
	 * Recursively does a quick sort on the array.
	 *
	 * @param array
	 *            the array
	 * @param start
	...
	/**
	 * Partitions the elements so that all elements less than the partition are
	 * left of it and all elements greater than the partition are right of it.
	 *
	 * @param array
	 *            the array
	 * @param start
	...
	/**
	 * Swaps two values using a temp variable
	 *
	 * @param a
	 *            the 2D array
	 * @param m
