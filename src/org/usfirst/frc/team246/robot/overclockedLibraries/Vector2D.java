...
public class Vector2D {
	...
	public String toString() {
		if (cartesian) {
			...
			return String.format("Vector2D [r=%.3f, theta=%.3f]", getMagnitude(), getAngle()); 
			// rounds to third decimal
		}
	}
	...
	public static Vector2D perpendicularProjection(Vector2D vector1, Vector2D vector2) {
		// the other (than the projection) component of vector1 with a
		// coordinate system relative to vector2
		vector1 = nullHandle(vector1);
		vector2 = nullHandle(vector2);
